  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-4 pt-4">
        <Card className="bg-beta-terracotta/10 border-beta-terracotta/20">
          <CardContent className="p-4 flex gap-3">
            <Info className="h-5 w-5 text-beta-terracotta shrink-0 mt-0.5" />
            <div>
              <p className="text-beta-cream text-sm font-medium">
                Como funciona?
              </p>
              <p className="text-beta-gray-blue text-xs mt-1 leading-relaxed">
      ...
      <div className="px-4 pt-4">
        {isLoading ? (
          <div className="space-y-4">
            <div className="h-[400px] rounded-lg bg-beta-navy/30 animate-pulse" />
            <div className="h-[200px] rounded-lg bg-beta-navy/30 animate-pulse" />
          </div>
        ) : (
          <BlockedDates
      ...
      <div className="px-4 pt-6">
        <Card className="bg-beta-navy/50 border-beta-gray-blue/20">
          <CardHeader className="pb-2">
            <CardTitle className="text-base text-beta-cream flex items-center gap-2">
          ...
          <CardContent className="space-y-3">
            <div className="flex gap-2">
              <div className="h-6 w-6 rounded-full bg-beta-terracotta/20 flex items-center justify-center shrink-0">
                <span className="text-beta-terracotta text-xs font-bold">1</span>
              </div>
              <p className="text-beta-gray-blue text-sm">
            ...
            <div className="flex gap-2">
              <div className="h-6 w-6 rounded-full bg-beta-terracotta/20 flex items-center justify-center shrink-0">
                <span className="text-beta-terracotta text-xs font-bold">2</span>
              </div>
              <p className="text-beta-gray-blue text-sm">
            ...
            <div className="flex gap-2">
              <div className="h-6 w-6 rounded-full bg-beta-terracotta/20 flex items-center justify-center shrink-0">
                <span className="text-beta-terracotta text-xs font-bold">3</span>
              </div>
              <p className="text-beta-gray-blue text-sm">
